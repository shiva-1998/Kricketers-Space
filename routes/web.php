...
Route::middleware(['auth', 'verified.email'])->group(function () {
    ...
    Route::get('/team-captain-players', [UserController::class, 'teamcaptainplayers'])->name('team-captain-players');
    Route::get('/team-captain-profile', [UserController::class, 'teamcaptainprofile'])->name('team-captain-profile');

    Route::post('/team-player/store', [UserController::class, 'teamStore'])->name('team-player.store');
});
