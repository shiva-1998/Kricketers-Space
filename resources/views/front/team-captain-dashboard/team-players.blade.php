            ...
            <div class="modal-body py-4">
                <form id="addPlayerForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control custom-input" placeholder="dd----yyyy">
                    </div>

                    <div class="mb-3">
                        <label class="form-label text-secondary small">Role</label>
                        <select class="form-select custom-input">
                            <option selected>All Rounder</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control custom-input" placeholder="9874562102">
                    </div>

                    <div class="mb-4">
                        <label class="form-label text-secondary small">Email</label>
                        <input type="email" class="form-control custom-input" placeholder="example@company.com">
                    </div>

                    <div class="upload-area mb-4">
                        <p class="text-secondary small mb-2">Upload team logo (optional)</p>
                        <div class="upload-box">
                            <input type="file" id="playerPhoto" hidden>
                            <label for="playerPhoto" class="small">Choose Photo</label>
                        </div>
                    </div>

                    <div class="d-flex gap-3 pt-2">
                        <button type="button" class="btn btn-outline-custom flex-grow-1" data-bs-dismiss="modal">Cancel</button>
...
<section class="container-fluid captain-dashboard-section">
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-start mb-4">
            ...
            <button type="button" class="btn btn-cyan-pill px-4 py-2" data-bs-toggle="modal" data-bs-target="#addPlayerModal">
                Add Player
            </button>
        </div>
        ...
        <div class="dashboard-card-wrap">
            <div class="table-responsive">
                <table class="table table-dark align-middle mb-0 players-table">
                    ...
                    <tbody>
                        <tr>
                            <td class="ps-4 j-number">06</td>
                            <td class="fw-bold">Vikram Patel</td>
                            <td class="text-secondary">FinanceHub</td>
                            <td>652</td>
                            <td>8</td>
                            <td class="text-secondary">Batsman</td>
                            <td class="text-end pe-4"><span class="rating-pill">9.2/10</span></td>
                        </tr>
                        <tr>
                            <td class="ps-4 j-number">11</td>
                            <td class="fw-bold">Anjali Gupta</td>
                            <td class="text-secondary">FinanceHub</td>
                            <td>589</td>
                            <td>8</td>
                            <td class="text-secondary">All Rounder</td>
                            <td class="text-end pe-4"><span class="rating-pill">9.2/10</span></td>
                        </tr>
                        <tr>
                            <td class="ps-4 j-number">12</td>
                            <td class="fw-bold">Rajesh Nair</td>
                            <td class="text-secondary">FinanceHub</td>
                            <td>521</td>
                            <td>8</td>
                            <td class="text-secondary">Batsman</td>
                        ...
                        <tr>
                            <td class="ps-4 j-number">25</td>
                            <td class="fw-bold">Sophia Chen</td>
                            <td class="text-secondary">FinanceHub</td>
                            <td>521</td>
                            <td>*</td>
                            <td class="text-secondary">Batsman</td>
                         ...
                         <tr>
                            <td class="ps-4 j-number">45</td>
                            <td class="fw-bold">Meghan Y</td>
                            <td class="text-secondary">FinanceHub</td>
                            <td>521</td>
                            <td>*</td>
                            <td class="text-secondary">Blower</td>
                            <td class="text-end pe-4"><span class="rating-pill">9.2/10</span></td>
                        </tr>
                    </tbody>
                </table>
